...
```
###**Chi square test Gender by Type of treatment sought --- FIX THIS**
```{r treatment sought supported vs. self-guided, eval=FALSE}
...
#summarise to just male-female for chi-square
tx_supported_mf <- tx_supported[c(9:10,12:13),]
tx_selfguided_mf <- tx_selfguided[c(9:10,12:13),]
