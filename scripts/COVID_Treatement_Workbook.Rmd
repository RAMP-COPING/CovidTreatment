...
combined_seek_gap_plot <- treat_dat_gap_count[,c(1,5:6)]
...
combined_seek_gap_plot$`Treatment not sought` <- 100-(combined_seek_gap_plot$`Treatment received`+combined_seek_gap_plot$`Treatment not received`)
  
#summary values per wave
combined_seek_gap_plot[,c(1,5:7)]

long_prop_receipt <- combined_seek_gap_plot[,c(1,5:7)] %>%
  pivot_longer(!wave, names_to = "received",values_to = "percent")

long_prop_receipt$received <- as.factor(long_prop_receipt$received)

long_prop_receipt$received <- factor(long_prop_receipt$received, levels=c("Treatment not sought","Treatment not received","Treatment received"), ordered=TRUE)
...
helpfulness_freq$`Supported` <- helpfulness$`% Valid`
helpful_freq_attritbutes <- attributes(helpfulness_freq)
helpfulness_freq$labels <- helpful_attritbutes$row.names
