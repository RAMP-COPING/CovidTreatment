...
seeksum$AnyHelpSeek <- apply(seeksum[2:10],1,function(x) ifelse(1 %in% x,1,0))
...
Note, because some people will have responded twice in a month when we were collecting twice weekly, will code this as: if they reported seeking treatment during that month at all.
```{r check number of overall treatment seeking}



table(seeksum$AnyHelpSeek)
