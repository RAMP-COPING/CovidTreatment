...
## Geographic: mapping alongside indices of multiple deprivation
...
```{r  clean indices of multiple deprivation data}
...
pl <- UK_ll %>% 
  ggplot() + 
  geom_sf(lwd = .1,color = 'black', aes(fill = TotalResponsesDistrict)) + 
  theme_void() +
  lims(fill = c(10,4000)) + 
