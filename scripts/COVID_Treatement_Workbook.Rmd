...
mapcolour <- 
 ...
 ggplot() +
    ...
    geom_point( aes(x=longitude, y=latitude, 
                    ...
                    color=SeekProportionTotalCounty), 
                alpha=1) +
...
mapcolourlabel <- 
 ...
 ggplot() +
    ...
    geom_point( aes(x=longitude, y=latitude, size=TotalResponsesCounty, color=SeekProportionTotalCounty), alpha=0.8) +
  
    geom_text_repel( data=postcode_full_County %>% 
                       arrange(SeekProportionTotalCounty) %>% 
                       tail(5), 
